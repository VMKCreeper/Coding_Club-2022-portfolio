...
class Timer:  # RYAN
    ...
    def countdown(self) -> bool: # docstring
    ...
    def convert_to_datetime(self, start_index: int, end_index: int) -> str: # docstring
    ...
    def get_elapsed_time(self, total: int, start_index: int, end_index: int) -> str: # docstring
        """Converts timer to datetime
